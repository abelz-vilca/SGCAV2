            ...
            <div class="card-body" style="background-color: #f6f6f6">
                ...
                <form method="POST" action="{{ route('criterio_estandar.update', $devolverisprograma->id )}}"
                        ...
                        <div class="row" style="background-color: #dddddd">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea id="justificacion" rows="9" columns="5" name="justificacion"
                                        value="<?php echo($devolverisprograma->justificacion); ?>"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="form-actions">
                        <input style='width:200px; height:50px' type="submit" class="btn btn-success btn-rounded"
                            value="Guardar">
